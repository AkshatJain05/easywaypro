...
export default function WebsiteOverview() {
  ...
  const faqs = [
    { q: "Is Easyway Classes free to use?", a: "Yes, most features are free with optional premium add-ons." },
    { q: "Can I export my resume as PDF?", a: "Yes, you can export ATS-friendly resumes in PDF format." },
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-gradient-to-br from-gray-950 to-black p-6 rounded-xl shadow-md border border-slate-700 hover:shadow-lg transition text-center">
            <h3 className="font-semibold mb-2 text-white">All-in-One Platform</h3>
            <p className="text-sm text-slate-400 text-center">Resume builder, AI chatbot, PYQs, notes, and coding tools all in one place.</p>
          </div>
          <div className="bg-gradient-to-br from-gray-950 to-black  p-6 rounded-xl shadow-md border border-slate-700 hover:shadow-lg transition text-center">
            <h3 className="font-semibold mb-2 text-white">Student-Friendly</h3>
            <p className="text-sm text-slate-400 text-center">Simple UI, free resources, and guides crafted for students and beginners.</p>
          </div>
          <div className="bg-gradient-to-br from-gray-950 to-black p-6 rounded-xl shadow-md border border-slate-700 hover:shadow-lg transition text-center">
            <h3 className="font-semibold mb-2 text-white">Regular Updates</h3>
            <p className="text-sm text-slate-400 text-center">Our team adds new notes, PYQs, and resume templates regularly.</p>
          </div>
           <div className="bg-gradient-to-br from-gray-950 to-black p-6 rounded-xl shadow-md border border-slate-700 hover:shadow-lg transition">
            <h3 className="font-semibold mb-2 text-white">Regular Updates</h3>
            <p className="text-sm text-slate-400 text-center">Our team adds new notes, PYQs, and resume templates regularly.</p>
          </div>
        </div>
